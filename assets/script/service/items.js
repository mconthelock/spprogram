...
export const createItemsCustomer = async (data) => {
	return new Promise((resolve, reject) => {
		$.ajax({
			url: `${process.env.APP_API}/sp/items-customer/create/`,
			type: "POST",
			dataType: "json",
			data: data,
			success: function (response) {
...
export const deleteItemsCustomer = async (data) => {
	return new Promise((resolve, reject) => {
		$.ajax({
			url: `${process.env.APP_API}/sp/items-customer/delete/`,
			type: "DELETE",
			dataType: "json",
			data: data,
			success: function (response) {

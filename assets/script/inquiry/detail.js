...
export async function getSearchHeader(formdata) {
	...
	const timeline_key = [
		...
		"timeline.START_SE_READ",
		"timeline.START_DE_READ",
		"timeline.START_DE_CONFIRM",
		"timeline.START_PKC_READ",
		"timeline.START_PKC_CONFIRM",
		"timeline.START_FIN_READ",
		"timeline.START_FIN_CONFIRM",
		"timeline.START_FCK_READ",
		"timeline.START_FCK_CONFIRM",
		"timeline.START_FMN_READ",
		"timeline.START_FMN_CONFIRM",
		"timeline.START_QT_READ",
		"timeline.START_QT_CONFIRM",
		"timeline.START_BM_CONFIRM",
		"timeline.START_SG_CONFIRM",
		"timeline.START_SE_CONFIRM",
		"timeline.END_MAR_SEND",
		"timeline.END_SG_READ",
		"timeline.END_SE_READ",
		"timeline.END_DE_READ",
		"timeline.END_DE_CONFIRM",
		"timeline.END_PKC_READ",
		"timeline.END_PKC_CONFIRM",
		"timeline.END_FIN_READ",
		"timeline.END_FIN_CONFIRM",
		"timeline.END_FCK_READ",
		"timeline.END_FCK_CONFIRM",
		"timeline.END_FMN_READ",
		"timeline.END_FMN_CONFIRM",
		"timeline.END_QT_READ",
		"timeline.END_QT_CONFIRM",
		"timeline.END_BM_CONFIRM",

...
@section('contents')
    ...
    <div class="flex gap-8">
                    ...
                    <div class="flex-1">
                        <fieldset class="fieldset flex gap-4">
                            <div class="flex-none">
                                ...
                                <input type="text" class="input w-full field-data req" data-map="ITEM_NO" maxlength="3"
                                    minlength="3" />
                            </div>
                            <div class="flex-1">
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" class="input w-full field-data uppercase req" data-map="ITEM_DWG" />
                        </fieldset>
                        ...
                        <fieldset class="fieldset flex gap-4">
                            ...
                            <div class="flex-1 hidden">
                                ...
                                <input type="text" class="input w-full field-data" data-map="CATEGORY" value="99" />
                            </div>
                        ...
                        <fieldset class="fieldset flex gap-4">
                            <div class="flex-1">
                                ...
                                <input type="number" class="input w-full field-data price-change" data-map="FCCOST"
                                    id="fccost" />
                            </div>

                            <div class="flex-1">
                                <legend class="fieldset-legend">%</legend>
                                <input type="number" class="input w-full field-data price-change" data-map="FCBASE"
                                    id="fcrate" value="1.3" />
                            </div>

                            <div class="flex-1">
                                <legend class="fieldset-legend">Total Cost</legend>
                                <input type="number" class="input w-full field-data" data-map="TCCOST" readonly
                                    id="tccost" />
                            </div>
                        </fieldset>
                        ...
                        <div class="flex mt-3 gap-3">
                            ...
                            <a class="btn btn-accent text-white items-center" href="#" id="back-to-list">
                                <span class="loading loading-spinner hidden"></span>
        ...
        <div class="flex-none w-80 hidden">
            <div class="card">

...
@section('contents')
    <input type="text" id="actionid" class="hidden" value="{{ $id }}">
    <input type="text" id="pageid" class="hidden" value="5">
    ...
    <form action="#" id="form-container" class="hidden" autocomplete="off">
        <div class="flex gap-8">
            ...
            <div class="flex-1 flex flex-col py-6 px-12 bg-white rounded-lg shadow">
                ...
                <div class="divider divider-start font-bold text-primary">Search by FIN action.</div>

                <fieldset class="fieldset ">
                    <legend class="fieldset-legend">Pre B/M Date</legend>
                    <div class="flex w-full items-center">
                        <label class="input">
                            <input type="text" class="grow fdate sdate-report" placeholder="yyyy-mm-dd"
                                name="timeline.START_BM_CONFIRM" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                        <div class="divider divider-horizontal"><i class="fi fi-ts-arrow-right text-2xl"></i></div>
                        <label class="input">
                            <input type="text" class="grow fdate edate-report" placeholder="yyyy-mm-dd"
                                name="timeline.END_BM_CONFIRM" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                    </div>
                </fieldset>
                ...
                <fieldset class="fieldset ">
                    <legend class="fieldset-legend">FIN Receive</legend>
                    <div class="flex w-full items-center">
                        <label class="input">
                            <input type="text" class="grow fdate sdate-report" placeholder="yyyy-mm-dd"
                                name="timeline.START_FIN_READ" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                        <div class="divider divider-horizontal"><i class="fi fi-ts-arrow-right text-2xl"></i></div>
                        <label class="input">
                            <input type="text" class="grow fdate edate-report" placeholder="yyyy-mm-dd"
                                name="timeline.END_FIN_READ" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                    </div>
                </fieldset>
                ...
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">FIN Confirm</legend>
                    <div class="flex w-full items-center">
                        <label class="input">
                            <input type="text" class="grow fdate sdate-report" placeholder="yyyy-mm-dd"
                                name="timeline.START_FIN_CONFIRM" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                        <div class="divider divider-horizontal"><i class="fi fi-ts-arrow-right text-2xl"></i></div>
                        <label class="input">
                            <input type="text" class="grow fdate edate-report" placeholder="yyyy-mm-dd"
                                name="timeline.END_FIN_CONFIRM" />
                            <i class="fi fi-tr-calendar-clock text-xl"></i>
                        </label>
                    </div>
                </fieldset>
...
@section('scripts')
    <script src="{{ $_ENV['APP_JS'] }}/fin_report.js?ver={{ $GLOBALS['version'] }}"></script>
@endsection

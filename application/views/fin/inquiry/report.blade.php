    ...
    <form action="#" id="form-container" class="hidden" autocomplete="off">
        <div class="flex gap-8">
            ...
            <div class="flex-1 flex flex-col py-6 px-12 bg-white rounded-lg shadow">
                ...
                <div class="divider divider-start font-bold text-primary">Search by Financial Info.</div>
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">Confirm Date.</legend>
                    <div class="flex w-full items-center">
                        <label class="input">
                            <input type="text" class="grow fdate sdate-report" placeholder="YYYY-MM-DD"
                ...
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">Check Date.</legend>
                    <div class="flex w-full items-center">
                        <label class="input">
                            <input type="text" class="grow fdate sdate-report" placeholder="YYYY-MM-DD"
                                name="timeline.GE_SG_READ" />
        ...
        <div class="flex justify-start my-5 gap-2" id="btn-report"></div>

...
@section('contents')
    ...
    <main id="form-container" class="grid grid-cols-1 lg:grid-cols-3 gap-6 font-xs" data="viewprj|viewinfo|viewdesigner">
    </main>
...
@section('scripts')
    <script src="{{ $_ENV['APP_JS'] }}/des_inqview.js?ver={{ $GLOBALS['version'] }}"></script>
@endsection

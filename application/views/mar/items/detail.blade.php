...
@section('contents')
    ...
    <input type="text" id="itemid" class="hiddenx" value="{{ $id }}" />
                ...
                <div class="card-body bg-base-100 border border-gray-300 rounded-lg flex-row gap-6 p-8">
                    <div class="flex-1">
                        <fieldset class="fieldset flex gap-4">
                            <div class="flex-none">
                                <legend class="fieldset-legend">Item No.</legend>
                                <input type="text" class="input w-full field-data" data-map="ITEM_NO" />
                            </div>
                            <div class="flex-1">
                                <legend class="fieldset-legend">Part Name</legend>
                                <input type="text" class="input w-full field-data" data-map="ITEM_NAME" />
                            </div>
                        </fieldset>

                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Drawing No.</legend>
                        ...
                        <fieldset class="fieldset flex gap-4">
                            <div class="flex-1">
                                ...
                                <input type="text" class="input w-full" data-map="FCCOST" />
                            </div>

                            <div class="flex-1">
                                <legend class="fieldset-legend">%</legend>
                                <input type="text" class="input w-full" data-map="FCBASE" value="1.3" readonly />
                            </div>

                            <div class="flex-1">
                                <legend class="fieldset-legend">Total Cost</legend>
                                <input type="text" class="input w-full" data-map="TCCOST" />
                            </div>
                        </fieldset>
                        ...
                        <div class="flex mt-3 gap-3">
                            ...
                            <a class="btn btn-accent text-white items-center" id="save-data"
                                href="{{ $_ENV['APP_ENV'] }}/mar/items">
                                <span class="loading loading-spinner hidden"></span>

...
class Quotation extends MY_Controller {
    ...
    public function detail($id, $mode = 1){
        $lists = array('quotation|viewinfo_quo|mar', 'quotation|viewinfo|maruser', 'viewquo|viewquo_out|viewinfo|viewmar');
        $data = array(
            'id' => $id,
            'list' => $lists[$mode-1],
            'mode' => $mode,
     ...
     public function show($id, $mode = 3){
        $lists = array('viewquo|viewinfo|mar', 'viewquo|viewinfo|maruser', 'viewquo|viewinfo|viewmar');
         $data = array(
            'id' => $id,
            'list' => $lists[$mode-1],
            'mode' => $mode,
